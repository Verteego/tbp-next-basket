...
def calculate_active_rp(customer_data, rp_intervals_support, day_of_next_purchase, max_rp_len=3):
...
def calculate_item_score(tree, rp_purchases, rp_intervals_support):
